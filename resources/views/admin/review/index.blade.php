        ...
        <div class="card">
            ...
            {{-- @can('member_create') --}}
                <div class="dt-action-buttons text-end">
                    <a class="btn btn-secondary create-new btn-primary pt-2 waves-effect waves-light" style="margin-right:12px"
                       tabindex="0" aria-controls="DataTables_Table_0" href="{{ url('admin/review/create') }}">
                        <span><i class="mdi mdi-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">Add Review</span>
                        </span>
                    </a>
                </div>
            {{-- @endcan --}}
            <div class="card-body">
                ...
                <div class="text-nowrap">
                    <table class="table table-responsive table-bordered review_table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center sortable cursor-pointer" data-sort="service">Service<span
                                        class="sort-indicator"></span></th>
                                <th class="text-center sortable cursor-pointer" data-sort="description">Discription<span
                                        class="sort-indicator"></span></th>
                    ...
                    success: function(response) {
                        ...
                        if (data === null || data.length === 0) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                let edit_url = "{{ url('admin/review/edit') }}";
                                let delete_url = "{{ url('admin/review/delete') }}";
                                ...
                                html += '<td class="text-center" style="overflow: hidden;">' + data[i].description.split(' ').slice(0, 10).join(' '); + '</td>';
                                ...
                                delete_url + '/' + data[i].id + '`,`.review_table`)" href="javascript:void(0);"><i class="mdi mdi-trash-can-outline me-1"></i> Delete</a></div></div></td>';
