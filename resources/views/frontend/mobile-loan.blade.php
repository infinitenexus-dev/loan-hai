    ...
    <section class="page-header bg-tertiary text-center">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <h1>Mobile Loan</h1>
                <p>LoanHai provides fast, convenient mobile loans, ensuring financial access on the go. With quick approvals
                    and flexible repayment options, we empower you to meet your financial needs seamlessly.</p>
            </div>
