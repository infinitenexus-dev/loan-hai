...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <h5 class="card-header">TermsCondition</h5>
            {{-- @can('member_create')
        ...
        <script>
           ...
           let page = 1;
            ...
            function fetchData(page, page_length, column, sortOrder) {
                ...
                $.ajax({
                    url: "{{ route('admin.termscondition.index') }}",
                    method: 'GET',
                    data: {
                        page: page,
                    ...
                    success: function(response) {
                        ...
                        if (data === null || data.length === 0) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                let edit_url = "{{ url('admin/termscondition/edit') }}";
                                ...
                                html += '<td class="text-center" style="overflow: hidden;">' + data[i].description.split(' ').slice(0, 20).join(' '); + '</td>';
                                html += '<td class="text-center"><div class="dropdown"> <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown" aria-expanded="false"> <i class="mdi mdi-dots-vertical"></i> </button><div class="dropdown-menu" style=""><a href="' +
                                        edit_url + '/' + data[i].id +
                                        '" id="editbutton" class="dropdown-item waves-effect"><i class="mdi mdi-pencil-outline me-1"></i> Edit</a>';
