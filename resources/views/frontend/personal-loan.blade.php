...
<section class="page-header bg-tertiary text-center">
    <div class="container">
        <div class="row justify-content-center">
            ...
            <h1>Securing a Personal Loan</h1>
            <p>A personal loan is a type of loan that allows individuals to borrow money for various purposes, such as
                debt consolidation, home improvements, or unexpected expenses, with fixed interest rates and repayment
                terms.</p>
        </div>
