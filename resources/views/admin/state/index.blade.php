        ...
        <div class="card">
            ...
            {{-- @can('member_create') --}}
                <div class="dt-action-buttons text-end">
                    <a class="btn btn-secondary create-new btn-primary pt-2 waves-effect waves-light" style="margin-right:12px"
                       tabindex="0" aria-controls="DataTables_Table_0" href="{{ url('admin/state/create') }}">
                        <span><i class="mdi mdi-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">Add State</span>
                        </span>
                    </a>
                </div>
            {{-- @endcan --}}
            <div class="card-body">
                ...
                <div class="text-nowrap">
                    <table class="table table-responsive table-bordered state_table table-striped">
                        <thead>
                            <tr>
                                <th class="text-center">SR</th>
                                <th class="text-center sortable cursor-pointer" data-sort="name">State<span
                    ...
                    success: function(response) {
                        ...
                        if (data === null || data.length === 0) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                let edit_url = "{{ url('admin/state/edit') }}";
                                let delete_url = "{{ url('admin/state/delete') }}";
                                ...
                                html += '<td class="text-center">' + data[i].state + '</td>';
                                ...
                                delete_url + '/' + data[i].id + '`,`.state_table`)" href="javascript:void(0);"><i class="mdi mdi-trash-can-outline me-1"></i> Delete</a></div></div></td>';
