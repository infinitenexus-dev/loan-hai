        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="text-nowrap">
                    <table class="table table-responsive table-bordered contactus_table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center sortable cursor-pointer" data-sort="email">Email<span
                                        class="sort-indicator"></span></th>
                                <th class="text-center sortable cursor-pointer" data-sort="message">Message<span
                                        class="sort-indicator"></span></th>
                    ...
                    success: function(response) {
                        ...
                        if (data === null || data.length === 0) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                let delete_url = "{{ url('admin/contactus/delete') }}";
                                ...
                                html += '<td class="text-center">' + data[i].message + '</td>';
                                html += '<td class="text-center"><a class="dropdown-item waves-effect" onclick="deleteRecord(`' +
                                delete_url + '/' + data[i].id + '`,`.contactus_table`)" href="javascript:void(0);"><i class="mdi mdi-trash-can-outline me-1"></i> Delete</a></div></div></td>';
