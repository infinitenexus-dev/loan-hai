    ...
    <div class="container">
        <div class="row">
            <div class="col-8 mx-auto text-center">
                <h1 class="mb-3 text-capitalize">About Us</h1>
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-7">
                <div class="section-title">
                    <p class="text-primary text-uppercase fw-bold mb-3">About LoanHai</p>
                    <h2 class="h1 mb-4">Daily Expense Loans <br> LoanHai Solutions</h2>
                    <div class="content pe-0 pe-lg-5">
                        <p>Our LoanHai loan service offers hassle-free solutions for daily expenses. With quick approvals and easy repayment options, we ensure that you can manage your day-to-day finances without stress. Say goodbye to financial worries and hello to convenience with our LoanHai loans.</p>
                        <p>
                        Our LoanHai offers loans for expenses, ensuring financial flexibility and convenience. Access funds quickly and responsibly manage your spending with tailored loan options. Simplify your financial decisions and enjoy the freedom to cover expenses without delay.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mt-5 mt-lg-0">
                <img loading="lazy" decoding="async" src="Frontend/images/about/9045616.jpg"
    ...
    <div class="container">
        <div class="row justify-content-around">
            <div class="col-lg-5">
                ...
                <p class="lead">We are a financial intermediary connecting businesses with loan providers. Our role involves assessing loan needs, gathering customer data, and facilitating loan applications with partner banks or financial institutions. </p>
                <div class="content">We streamline the process, ensuring clients receive suitable loans while assisting banks in identifying creditworthy applicants.</div>
            </div>
            <div class="col-lg-5">
                <div class="section-title">
                    <p class="text-primary text-uppercase fw-bold mb-3"></p>
                ...
                <p class="lead">We offer comprehensive financial solutions tailored to your needs, including business loans, investment advice, strategic planning, and personalized support to help you achieve your financial goals and thrive in today's dynamic market.</p>
                <div class="content">
                   <p>Comprehensive financial solutions, including loans, investment advice, and tailored services for your business growth and success.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
                ...
                <p class="px-lg-5">Efficiently assess, decide, and act for prompt, informed solutions</p>
            </div>
            <div class="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
                <div class="icon icon-lg bg-transparent mb-4"><i class="fas fa-file-alt text-primary"></i>
                </div>
                <h3>Submit Your Info</h3>
                <p class="px-lg-5">Share your details for personalized assistance and support.</p>
            </div>
            <div class="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
                <div class="icon icon-lg bg-transparent mb-4"><i class="fas fa-briefcase text-primary"></i>
                </div>
                <h3>Funds To You</h3>
                <p class="px-lg-5">Accessible, flexible, and reliable financial solutions.</p>
            </div>
        </div>
    </div>
</section>

<section class="section core-value bg-tertiary about-section">
    <div class="container">
        <div class="row align-items-center">
                ...
                <div class="row position-relative gy-4">
                    <div class="icon-box-item col-md-6">
                        <div class="block bg-white">
                            ...
                            <p class="mb-0">Empowering dreams with support.</p>
                        </div>
                    </div>
                    <div class="icon-box-item col-md-6">
                        <div class="block bg-white">
                            ...
                            <p class="mb-0">Clear, honest financial dealings.</p>
                        </div>
                    </div>
                    <div class="icon-box-item col-md-6">
                        <div class="block bg-white">
                            ...
                            <p class="mb-0">Trustworthy support for all.</p>
                        </div>
                    </div>
                    <div class="icon-box-item col-md-6">
                        <div class="block bg-white">
                            ...
                            <p class="mb-0">Teamwork for mutual success.</p>
                        </div>
                    </div>
                    <div class="has-shapes">
                        <svg class="shape shape-1 text-primary" width="71" height="71" viewBox="0 0 119 119" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <div class="col-lg-6 mt-5 mt-lg-0">
                <div class="section-title ps-0 ps-lg-5">
                    ...
                    <div class="content">
                        <p>Our core values revolve around integrity, transparency, customer empowerment, and collaboration. We uphold honesty in all interactions, maintain transparent processes, empower customers with knowledge, and foster partnerships to provide the best loan solutions.</p>
                        <p>These values drive us to create meaningful impact and build lasting relationships based on trust and mutual benefit.</p>
                    </div>
                </div>
            </div>
        </div>
