    ...
    <section class="page-header bg-tertiary text-center">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <h1>New Car Loan</h1>
                <p>
                    LoanHai provides hassle-free New Car Loans, ensuring quick approvals, competitive interest rates, and
                    flexible repayment options. Drive your dream car with ease, thanks to LoanHai's efficient financing
                    solutions.</p>
            </div>
            <a type="button" class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#applyLoan">Apply Now
            </a>
        </div>
    </section>
                ...
                <div class="col-lg-10">
                    <ul class="payment_info_tab nav nav-pills justify-content-center mb-4" id="pills-tab" role="tablist">
                        <li class="nav-item m-2" role="presentation"> <a
                                ...
                                aria-controls="pills-how-much-can-i-recive" aria-selected="true">Check eligibility</a>
                        </li>
                        <li class="nav-item m-2" role="presentation"> <a
                                ...
                                aria-controls="pills-how-much-does-it-costs" aria-selected="true">Upload KYC Documents</a>
                        </li>
                        <li class="nav-item m-2" role="presentation"> <a
                                class="nav-link btn btn-outline-primary effect-none text-dark "
                                id="pills-how-do-i-repay-tab" data-bs-toggle="pill" href="#pills-how-do-i-repay"
                                role="tab" aria-controls="pills-how-do-i-repay" aria-selected="true">Get your money</a>
                        </li>
                    </ul>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 order-1 order-md-0">
                                    <div class="content-block">
                                        <h3 class="mb-4">Check eligibility click to apply now and provide your details
                                        </h3>
                                        <div class="content">
