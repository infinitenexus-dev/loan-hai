        ...
        <div class="card">
            ...
            {{-- @can('member_create') --}}
                <div class="dt-action-buttons text-end">
                    <a class="btn btn-secondary create-new btn-primary pt-2 waves-effect waves-light" style="margin-right:12px"
                       tabindex="0" aria-controls="DataTables_Table_0" href="{{ url('admin/agent/create') }}">
                        <span><i class="mdi mdi-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">Add Agent</span>
                        </span>
                    </a>
                </div>
            {{-- @endcan --}}
            <div class="card-body">
                ...
                <div class="text-nowrap">
                    <table class="table table-responsive table-bordered agent_table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center sortable cursor-pointer" data-sort="phone">phone<span
                                        class="sort-indicator"></span></th>
                                <th class="text-center sortable cursor-pointer" data-sort="age">Address<span
                                        class="sort-indicator"></span></th>
                                <th class="text-center sortable cursor-pointer" data-sort="email">City<span
                                        class="sort-indicator"></span></th>
                                <th class="text-center sortable cursor-pointer" data-sort="income">State<span
                                        class="sort-indicator"></span></th>
                    ...
                    success: function(response) {
                        ...
                        if (data === null || data.length === 0) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                let edit_url = "{{ url('admin/agent/edit') }}";
                                let delete_url = "{{ url('admin/agent/delete') }}";
                                ...
                                html += '<td class="text-center">' + data[i].address + '</td>';
                                html += '<td class="text-center">' + data[i].city_name + '</td>';
                                ...
                                delete_url + '/' + data[i].id + '`,`.agent_table`)" href="javascript:void(0);"><i class="mdi mdi-trash-can-outline me-1"></i> Delete</a></div></div></td>';
