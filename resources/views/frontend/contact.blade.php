        ...
        <div class="row">
            <div class="col-8 mx-auto text-center">
                ...
                <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                    ...
                    <li class="list-inline-item">/ &nbsp; <a href="{{route('contact')}}">Contact</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6">
                <div class="section-title text-center">
                    <h2 class="text-primary text-uppercase fw-bold mb-3">Contact With us</h2>
                    <p>If you have a question about our service or have an issue to report, please contact us by phone at: +91 95586 33008. Once we receive your request, our customer service team will get back to you as soon as possible.</p>
                </div>
            </div>
            <div class="col-lg-10">
                            ...
                            <div class="contact-form">
                                <form  action="#"  id="contactForm">
                                    ...
                                    <div class="form-group mb-4 pb-2">
                                        ...
                                        <input class="form-control shadow-none" id="contact_email">
                                        <div class="error"></div>
                                    </div>
                                    <div class="form-group mb-4 pb-2">
                                        <label for="message" class="form-label">Write
                                            Message</label>
                                        <textarea class="form-control shadow-none" id="contact_message"
                                            rows="3"></textarea>
                                            <div class="error"></div>
                                    </div>
                            ...
                            <div class="contact-info">
                                <div class="block mt-0">
                                    ...
                                    <div class="content">Call Us We Will Be Happy To Help
                                        ...
                                        <br><a href="mailto:info@loanhai.in">info@loanhai.in</a>
                                        <br>Monday - Friday
                                        <br>9AM TO 8PM
                                    </div>
                                </div>
...
$(document).ready(function() {
    $('#contactForm').submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ route('contact.store') }}", // Use the form's action URL
            data: formData,
            ...
            error: function(xhr, status, error) {
                ...
                $.each(errors, function(key, value) {
                    $('#' + key).next('.error').text(value).addClass('is-invalid');
                });
            }
        });
    });
