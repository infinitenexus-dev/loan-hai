    ...
    <div class="container">
        <div class="row">
            <div class="col-8 mx-auto text-center">
                <h1 class="mb-3 text-capitalize">Our Services</h1>
...
<h2 class="mb-0 mt-0"></h2>
<section class="section">
    <div class="container">
        <div class="row justify-content-center">
            <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                <div class="rounded shadow py-5 px-4">
                    <div class="icon" style="background-color: rgba(145, 122, 235, 0.2) !important;"> <i class="fas fa-user" style='color:#917AEB;'></i>
                    </div>
                    <h3 class="mb-3">Personal loan</h3>
                    <p class="mb-4">Personal loans up to 5 lakhs offer financial flexibility, aiding various needs like education, medical expenses, or home improvements.</p> <a class="btn btn-sm btn-outline-primary services_btn"
                        href="{{ route('personal-loan') }}">View Details <i class="las la-arrow-right ms-1"></i></a>
                </div>
            </div>
            <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                <div class="rounded shadow py-5 px-4">
                    <div class="icon" style="background-color: rgba(81, 181, 109, 0.2);"> <i class="fas fa-house-user" style='color:green;'></i>
                    </div>
                    <h3 class="mb-3">Home Improvement Loan</h3>
                    <p class="mb-4">Renovate your space with a Home Improvement Loan, making your dream upgrades a reality with manageable repayment options.</p>
                    <a class="btn btn-sm btn-outline-primary services_btn" href="{{ route('home-improvement-loan') }}">View Details <i
                            class="las la-arrow-right ms-1"></i></a>
                </div>
            </div>
            <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                <div class="rounded shadow py-5 px-4">
                    <div class="icon" style="background-color: rgba(145, 122, 235, 0.2) !important;"> <i class="fas fa-user-graduate" style='color:#917AEB;'></i>
                    </div>
                    <h3 class="mb-3">Education Loan</h3>
                    <p class="mb-4">Get immediate ₹5 Lakhs loan for educational expenses,
                        ensuring uninterrupted learning and growth opportunities.</p>
                    <a class="btn btn-sm btn-outline-primary services_btn" href="{{ route('education-loan') }}">View Details <i
                            class="las la-arrow-right ms-1"></i></a>
                </div>
            </div>
            <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                <div class="rounded shadow py-5 px-4">
                    <div class="icon" style="background-color: rgba(81, 181, 109, 0.2);"> <i class="fas fa-mobile" style='color:green;'></i>
                    </div>
                    <h3 class="mb-3">Mobile Loan</h3>
                    <p class="mb-4">Access instant mobile loans up to ₹2 Lakhs with seamless
                        application and quick approval process.</p>
                    <a class="btn btn-sm btn-outline-primary services_btn" href="{{ route('mobile-loan') }}">View Details <i
                            class="las la-arrow-right ms-1"></i></a>
                </div>
            </div>
            <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                <div class="rounded shadow py-5 px-4">
                    <div class="icon" style="background-color: rgba(145, 122, 235, 0.2) !important;"> <i class="fas fa-car" style='color:#917AEB;'></i>
                    </div>
                    <h3 class="mb-3">New Car Loan</h3>
                    <p class="mb-4">Secure funding for your new car with hassle-free loans of up
                        to ₹5 Lakhs available instantly.</p>
                    <a class="btn btn-sm btn-outline-primary services_btn" href="{{ route('new-car-loan') }}">View Details <i
                            class="las la-arrow-right ms-1"></i></a>
                </div>
            </div>
            <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                <div class="rounded shadow py-5 px-4">
                    <div class="icon" style="background-color: rgba(81, 181, 109, 0.2);"> <i class="fas fa-building" style="color:green;"></i>
                    </div>
                    <h3 class="mb-3">Business Loan</h3>
                    <p class="mb-4">These loans offer businesses the capital they need to navigate cash flow challenges</p>
                    <a class="btn btn-sm btn-outline-primary services_btn" href="{{ route('business-loan') }}">View Details <i
                            class="las la-arrow-right ms-1"></i></a>
                </div>
            </div>
			<div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                <div class="rounded shadow py-5 px-4">
                    <div class="icon" style="background-color: rgba(145, 122, 235, 0.2) !important;"> <i class="fas fa-laptop" style='color:#917AEB;'></i>
                    </div>
                    <h3 class="mb-3">Laptop Loan</h3>
                    <p class="mb-4">Fast, reliable laptop loan service tailored to your specific needs.</p>
                    <a class="btn btn-sm btn-outline-primary services_btn" href="{{ route('laptop-loan') }}">View Details <i
                            class="las la-arrow-right ms-1"></i></a>
                </div>
            </div>
			<div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                <div class="rounded shadow py-5 px-4">
                    <div class="icon" style="background-color: rgba(81, 181, 109, 0.2);"> <i class="fas fa-motorcycle" style="color:green;"></i>
                    </div>
                    <h3 class="mb-3">Two Wheeler Loan</h3>
                    <p class="mb-4">Fast approval, low rates, easy payments for your dream bike!</p>
                    <a class="btn btn-sm btn-outline-primary services_btn" href="{{ route('two-wheeler-loan') }}">View Details <i
                            class="las la-arrow-right ms-1"></i></a>
                </div>
            </div>
        </div>
