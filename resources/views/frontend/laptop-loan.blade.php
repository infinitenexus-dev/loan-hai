...
<section class="page-header bg-tertiary text-center">
    <div class="container">
        <div class="row justify-content-center">
            ...
            <h1>Laptop Loan</h1>
            <p>LoanHai provides hassle-free Laptop Loans, ensuring quick access to technology for personal or professional needs. With flexible repayment options and easy application processes, we empower you to stay connected seamlessly.</p>
        </div>
