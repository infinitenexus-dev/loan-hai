        ...
        <div class="card">
            ...
            {{-- @can('member_create') --}}
                <div class="dt-action-buttons text-end">
                    <a class="btn btn-secondary create-new btn-primary pt-2 waves-effect waves-light" style="margin-right:12px"
                       tabindex="0" aria-controls="DataTables_Table_0" href="{{ url('admin/services/create') }}">
                        <span><i class="mdi mdi-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">Add Service</span>
                        </span>
                    </a>
                </div>
            {{-- @endcan --}}
            <div class="card-body">
                ...
                <div class="text-nowrap">
                    <table class="table table-responsive table-bordered service_table table-striped">
                        <thead>
                            <tr>
                                <th class="text-center">SR</th>
                                <th class="text-center sortable cursor-pointer" data-sort="service_name">Service Name<span
                    ...
                    success: function(response) {
                        ...
                        if (data === null || data.length === 0) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                let edit_url = "{{ url('admin/services/edit') }}";
                                let delete_url = "{{ url('admin/services/delete') }}";
                                ...
                                delete_url + '/' + data[i].id + '`,`.service_table`)" href="javascript:void(0);"><i class="mdi mdi-trash-can-outline me-1"></i> Delete</a></div></div></td>';
