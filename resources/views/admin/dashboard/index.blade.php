    ...
    <div class="row gy-4">
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
              ...
              <div class="d-flex align-items-center">
                <p class="mb-0 text-success me-1">Today New {{$userCountToday}}</p>
                <i class="mdi mdi-chevron-up text-success"></i>
              </div>
            </div>
            <div class="card-info mt-4 pt-1 mt-lg-1 mt-xl-4">
              <h5 class="mb-2">{{$totaluser}}</h5>
              <p class="text-muted mb-lg-2 mb-xl-3">Total Clints</p>
              <div class="badge bg-label-secondary rounded-pill">Last 1 Year</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card h-100">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
              ...
              <div class="d-flex align-items-center">
                <p class="mb-0 text-success me-1">Today New {{$contactCountToday}}</p>
                <i class="mdi mdi-chevron-up text-success"></i>
              </div>
            </div>
            <div class="card-info mt-4 pt-1 mt-lg-1 mt-xl-4">
              <h5 class="mb-2">{{$contactCount}}</h5>
              <p class="text-muted mb-lg-2 mb-xl-3">Total Contact Us</p>
              <div class="badge bg-label-secondary rounded-pill">Last 1 Year</div>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-4 col-sm-6">
        <div class="card h-100">
          <div class="card-header pb-0">
            ...
            <span class="d-block mb-2 text-muted">Profit</span>
          </div>
          <div class="card-body">
            <div id="sessions"></div>
          </div>
      ...
      <div class="col-12 col-xl-12">
        <div class="container-xxl flex-grow-1 container-p-y">
          ...
          <div class="card">
              <h5 class="card-header">Resent Customers</h5>
              {{-- @can('member_create')
